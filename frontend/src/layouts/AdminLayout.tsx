...
export default function AdminLayout() {
  ...
  const menuItems = [
    ...
    { path: '/payments', label: 'Pagos y Caja', icon: (
      <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="space-y-6">
          ...
          <div className="hidden md:flex items-center gap-3 px-2">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[10px] text-emerald-400 font-bold uppercase tracking-wider">Administración</span>
            </div>
          </div>
        ...
        <header className="hidden md:flex bg-slate-900 border-b border-slate-850 h-16 shrink-0 items-center justify-between px-8 z-10">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-[10px] uppercase font-bold tracking-widest text-[#39D353] bg-[#39D353]/10 border border-[#39D353]/20 px-2.5 py-0.5 rounded-full">
                {user?.role}
              </span>
            </div>
          </div>
